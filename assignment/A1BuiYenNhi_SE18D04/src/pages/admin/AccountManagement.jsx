...
const roleLabel = (role) => (role === 1 ? 'Admin' : 'Staff')
...
export default function AccountManagement() {
  ...
  const handleSave = () => {
    ...
    if (editingUser) {
      setUsers((prev) =>
        prev.map((u) =>
          u.accountID === editingUser.accountID
            ? {
                ...u,
                ...form,
                accountPassword:
                  form.accountPassword || u.accountPassword,
              }
            : u
        )
      )
      ...
      setUsers((prev) => [...prev, { ...form, accountID: newId }])
    }
    setModalOpen(false)
  }
